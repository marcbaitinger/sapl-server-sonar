...
public class ApplicationConfigService {
    ...
    private void initHttpEndpointConfig() {
        ...
        if (this.getAt(httpEndpoint.sslEnabledPath, false).equals(true)) {
    ...
    private void initRsocketEndpointConfig() {
        ...
        if (this.getAt(rsocketEndpoint.sslEnabledPath, false).equals(true)) {
    ...
    private void initApiAuthenticationConfig() {
        this.apiAuthenticationConfig
                .setBasicAuthEnabled(this.getAt(ApiAuthenticationConfig.BASICAUTH_PATH, false).equals(true));
        this.apiAuthenticationConfig
                .setApiKeyAuthEnabled(this.getAt(ApiAuthenticationConfig.APIKEYAUTH_PATH, false).equals(true));
        this.apiAuthenticationConfig
        ...
        this.apiAuthenticationConfig.setApiKeyCachingEnabled(
                this.getAt(ApiAuthenticationConfig.APIKEYCACHINGENABLED_PATH, false).equals(true));
